...
for netD in netD_architectures:
    test_script.append(
        ...
        f"--direction BtoA --num_test {num_test} --epoch latest --results_dir {f'results/hyperparameters/hyperparameter_netD'} --netD {netD} --gpu_ids {gpu_ids} --checkpoints_dir {checkpoints_dir}"
    )
