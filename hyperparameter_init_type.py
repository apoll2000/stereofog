...
for init_type in init_types:
    test_script.append(
        ...
        f"--direction BtoA --num_test {num_test} --epoch latest --results_dir {f'results/hyperparameters/hyperparameter_init_type'} --init_type {init_type} --gpu_ids {gpu_ids} --checkpoints_dir {checkpoints_dir}"
    )
