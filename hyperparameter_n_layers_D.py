...
for layers in n_layers_D:
    test_script.append(
        ...
        f"--direction BtoA --num_test {num_test} --epoch latest --results_dir {f'results/hyperparameters/hyperparameter_n_layers_D'} --netD n_layers --n_layers_D {layers} --checkpoints_dir {checkpoints_dir}"
    )
